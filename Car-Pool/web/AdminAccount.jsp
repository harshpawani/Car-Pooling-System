  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.5.2/js/bootstrap.min.js"></script>
    ...
    <center>
        ...
        " >
            ...
            <h2 style="color:white;">Admin Account</h2>
           <%
             ...
             String data = "select * from admindetails where uname='"+ul+"'";
        ...
        <input type="hidden" name="id" value='<%=rs.getString("id")%>'>
            ...
            <div class="form-group">
                ...
                <input type="text" name="Address1" value='<%=rs.getString("Address1")%>'>
            </div>
            <div class="form-group">
                <label>Address 2</label>
                <input type="text"  name="Address2" value='<%=rs.getString("Address2")%>'>
            </div>
            <div class="form-group">
                <label>City</label>
...
<%
    ...
    String g = request.getParameter("Address2");
    ...
    {
        String query = "UPDATE `admindetails` SET `Name`=?,`Mobile`=?,`Email`=?,`DOB`=?,`Address1`=?,`Address2`=?,`City`=?,`State`=?,`Country`=? where id='"+a+"'";
