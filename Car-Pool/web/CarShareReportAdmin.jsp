...
<html>
  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.5.2/js/bootstrap.min.js"></script>
    ...
    <body>
        ...
        <p></p>
        <table class="table table-bordered table-striped " align="center" style="color: white; background-color: black; box-shadow: 0 15px 25px rgba(0,0,0,.6);">
                         ...
                         while(rs.next())
                         {
                             ...
                             <tr style="color: white; font-size: 16px; font-family: arial; background: linear-gradient(#141e30, #243b55); font-family: Abril Fatface;">
                                ...
                                <td class="text-center">
                                    <a href='AdminEDITsharereport.jsp?u=<%=rs.getString("id")%>' class="btn btn-warning">Edit</a>
                                    <a href='AdminDELETEsharereport.jsp?d=<%=rs.getString("id")%>' class="btn btn-danger">Delete</a>
                                </td>
                              </tr>
                             <%
                         }
