                ...
                <% 
                    try{
                        ...
                        String ul = (String)session.getAttribute("username");
                         ...
                         {
                             data = "select * from carreport where Owner like '%"+ul+"%'";
                         }
                         ...
                         while(rs.next())
                         {
                             ...
                             <tr style="color: white; font-size: 16px; font-family: arial; background: linear-gradient(#141e30, #243b55); font-family: Abril Fatface;">
                                ...
                                <td class="text-center">
                                    <a href='EDITcarreport.jsp?u=<%=rs.getString("SrNo")%>' class="btn btn-warning">Edit</a>
                                    <a href='DELETEcarreport.jsp?d=<%=rs.getString("SrNo")%>' class="btn btn-danger">Delete</a>
                                </td>
                              </tr>
                             <%
                         }
