...
Statement st=conn.createStatement();
 ResultSet rs=st.executeQuery("select EmpID  from edetails where EmpID='"+eid+"'");

if(rs.next())
	{out.println("User already exist");
     %><a href="AdminEmpRegis.jsp"><strong>Please Login</strong></a>
     <%
}
else{
PreparedStatement pst = conn.prepareStatement("insert into edetails(EmpID,FirstName,LastName,Email,ContactNumber,Username,Password,Password2,Question,Answer) values(?,?,?,?,?,?,?,?,?,?)");
pst.setString(1,eid);
